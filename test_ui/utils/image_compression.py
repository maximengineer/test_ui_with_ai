...
def compress_base64_screenshot(base64_data: str, output_path: Path) -> Tuple[bool, str, int]:
    """
    ...
    try:
        ...
        success, compressed_data, format_used = _try_compression_methods(pil_image, original_size)
        ...
        message = (f"Compressed using {format_used} - "
...
def _try_compression_methods(pil_image: Image.Image, original_size: int) -> Tuple[bool, bytes, str]:
